CREATE TABLE [dbo].[field_inspect] (
    ...
    [pass_class]              INT             CONSTRAINT [DF_field_inspect_pass_class] DEFAULT ((0)) NOT NULL,
    ...
    [path_cms]                INT             CONSTRAINT [DF_field_inspect_path_cms] DEFAULT ((255)) NOT NULL,
    [path_erw]                INT             CONSTRAINT [DF_field_inspect_path_erw] DEFAULT ((255)) NOT NULL,
    [path_pstvd]              INT             CONSTRAINT [DF_field_inspect_path_pstvd] DEFAULT ((255)) NOT NULL,
    [path_pva]                INT             CONSTRAINT [DF_field_inspect_path_pva] DEFAULT ((255)) NOT NULL,
    [path_pvm]                INT             CONSTRAINT [DF_field_inspect_path_pvm] DEFAULT ((255)) NOT NULL,
    [path_plrv]               INT             CONSTRAINT [DF_field_inspect_path_plrv] DEFAULT ((255)) NOT NULL,
    [path_pvs]                INT             CONSTRAINT [DF_field_inspect_path_pvs] DEFAULT ((255)) NOT NULL,
    [path_pvx]                INT             CONSTRAINT [DF_field_inspect_path_pvx] DEFAULT ((255)) NOT NULL,
    [path_pvy]                INT             CONSTRAINT [DF_field_inspect_path_pvy] DEFAULT ((255)) NOT NULL,
    [path_comments]           VARCHAR (1000)  NULL,
    [thc_percent]             NUMERIC (7, 4)  NULL,
    [potato_pounds_harvested] INT             CONSTRAINT [DF_field_inspect_potato_pounds_harvested] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_field_inspect] PRIMARY KEY CLUSTERED ([id] ASC)
);
