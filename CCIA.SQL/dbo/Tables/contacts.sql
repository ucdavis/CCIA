CREATE TABLE [dbo].[contacts] (
    ...
    [password_hash]                       VARBINARY (500) NULL,
    [salt]                                VARBINARY (500) CONSTRAINT [DF_contacts_salt2] DEFAULT (Crypt_Gen_Random((50))) NULL,
    ...
    [applicationNotices]                  BIT             CONSTRAINT [DF_contacts_applicationNotices] DEFAULT ((0)) NOT NULL,
    [SeedNotices]                         BIT             CONSTRAINT [DF_contacts_SeedNotices] DEFAULT ((0)) NOT NULL,
    [TagNotices]                          BIT             CONSTRAINT [DF_contacts_TagNotices] DEFAULT ((0)) NOT NULL,
    [OECDNotices]                         BIT             CONSTRAINT [DF_contacts_OECDNotices] DEFAULT ((0)) NOT NULL,
    [BlendNotices]                        BIT             CONSTRAINT [DF_contacts_BlendNotices] DEFAULT ((0)) NOT NULL,
    [BulkSalesNotices]                    BIT             CONSTRAINT [DF_contacts_BulkSalesNotices] DEFAULT ((0)) NOT NULL,
    [TransferNotices]                     BIT             CONSTRAINT [DF_contacts_TransferNotices] DEFAULT ((0)) NOT NULL,
    [AllowOrgUpdate]                      BIT             CONSTRAINT [DF_contacts_AllowOrgUpdate] DEFAULT ((0)) NOT NULL,
