CREATE TABLE [dbo].[ccia_employees] (
    ...
    [admin]                   BIT          CONSTRAINT [DF_ccia_employees_admin] DEFAULT ((0)) NOT NULL,
    [ConditionerStatusUpdate] BIT          CONSTRAINT [DF_ccia_employees_ConditionerStatusUpdate] DEFAULT ((0)) NOT NULL,
    [UpdateMapPermissions]    BIT          CONSTRAINT [DF_ccia_employees_UpdateMapPermissions] DEFAULT ((0)) NOT NULL,
    [lactracker]              BIT          CONSTRAINT [DF_ccia_employees_lactracker] DEFAULT ((0)) NOT NULL
);
