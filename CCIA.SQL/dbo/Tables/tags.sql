CREATE TABLE [dbo].[tags] (
    ...
    [count_used]           INT             NULL,
    [tag_type]             TINYINT         CONSTRAINT [DF_tags_tag_type] DEFAULT ((2)) NULL,
    [tag_extras_overrun]   TINYINT         CONSTRAINT [DF_tags_tag_extras_overrun] DEFAULT ((0)) NOT NULL,
    ...
    [series_numbered]      BIT             CONSTRAINT [DF_tags_series_numbered] DEFAULT ((0)) NOT NULL,
    ...
    [oecd_request]         BIT             CONSTRAINT [DF_tags_oecd_request_1] DEFAULT ((0)) NULL,
    [ps_number]            VARCHAR (50)    NULL,
    [oecd_tag_type]        TINYINT         NULL,
    [date_sealed]          DATE            NULL,
    [oecd_country]         SMALLINT        NULL,
