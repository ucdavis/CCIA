CREATE TABLE [dbo].[seedlab_germination] (
    ...
    [insufficient_size_germ] BIT            CONSTRAINT [DF_seedlab_germination_insufficient_size] DEFAULT ((0)) NOT NULL,
    [calc_germ]              TINYINT        NULL,
    [calc_abnormal]          TINYINT        NULL,
    [calc_hard]              TINYINT        NULL,
    [calc_dormant]           TINYINT        NULL,
    [calc_dead]              TINYINT        NULL,
    CONSTRAINT [PK_seedlab_germination] PRIMARY KEY NONCLUSTERED ([lab_id] ASC)
);
