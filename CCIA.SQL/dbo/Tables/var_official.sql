CREATE TABLE [dbo].[var_official] (
    ...
    [description_on_file]             BIT            CONSTRAINT [DF_var_official_description_on_file] DEFAULT ((0)) NOT NULL,
    [crop_id]                         INT            NULL,
    ...
    [state_harvested]                 INT            NULL,
    [number_of_generations_permitted] INT            NULL,
