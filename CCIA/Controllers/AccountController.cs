...
namespace CCIA.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            {
                var test = await _dbContext.Contacts.Where(c => c.EmailAddr == model.Email).ToListAsync();
                foreach (Contacts contact in test)
                {
                    if (VerifyPassword(model, contact))
                    {
        ...
        public bool VerifyPassword(LoginViewModel model, Contacts contact)
        {
            byte[] hashed = KeyDerivation.Pbkdf2(
